package mock.location.xposed.helpers.reflect
...
object Log {
     ...
     * from plain logcat too (adb logcat -s MockLocation).
     *
     * The level is carried into logcat rather than folded into the message.
     * Everything used to go out at INFO, so `logcat MockLocation:E` - the first
