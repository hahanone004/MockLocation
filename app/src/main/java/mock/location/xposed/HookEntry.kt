...
import mock.location.xposed.cellar.NetworkTypeHooker
import mock.location.xposed.cellar.PhoneInterfaceManagerHooker
import mock.location.xposed.cellar.SimIdentityHooker
import mock.location.xposed.cellar.TelephonyRegistryHooker
import mock.location.xposed.helpers.ConfigGateway
import mock.location.xposed.location.LocationHooker
    ...
    override fun handleLoadPackage(lpparam: XC_LoadPackage.LoadPackageParam?) {
        ...
        when (lpparam.packageName) {
            BuildConfig.APPLICATION_ID -> {
                ...
                val clazz = lpparam.classLoader.loadClass("mock.location.app.ui.activities.MainActivity")
